...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-11-24 11:49`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/e5da53f7-062b-4dd5-95df-fca913d843e6.git
$ cd e5da53f7-062b-4dd5-95df-fca913d843e6
```
